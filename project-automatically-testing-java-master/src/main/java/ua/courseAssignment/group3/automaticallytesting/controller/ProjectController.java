...
import ua.courseAssignment.group3.automaticallytesting.service.ProjectService;
import ua.courseAssignment.group3.automaticallytesting.service.ServiceImpl.UserPrincipal;

@RestController
@CrossOrigin(origins = "*")@RequestMapping("/projects")
@Slf4j
